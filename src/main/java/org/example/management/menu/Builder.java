...
public class Builder {
    ...
    public void buildMenu() {
        ...
        rootMenu.addMenuItem(new MenuItem(1, "Repairer menu", null, repairerMenu()));
        rootMenu.addMenuItem(new MenuItem(2, "Garage slot menu", null, garageSlotMenu()));
        rootMenu.addMenuItem(new MenuItem(3, "Order menu", null, orderMenu()));
    ...
    private Menu repairerMenu() {
        ...
        repairerMenu.addMenuItem(new MenuItem(4, "View list repairer", null, listRepairerMenu()));
        repairerMenu.addMenuItem(new MenuItem(5, "Change repairer status", new ChangeStatus(), repairerMenu));
        repairerMenu.addMenuItem(new MenuItem(6, "Back to previous menu", null, rootMenu));
    ...
    private Menu listRepairerMenu() {
        ...
        listRepairerMenu.addMenuItem(new MenuItem(4, "Back to previous menu", null, rootMenu));
    ...
    private Menu garageSlotMenu() {
        ...
        garageSlotMenu.addMenuItem(new MenuItem(4, "View all garage slots", null, listGarageSlotsMenu()));
        garageSlotMenu.addMenuItem(new MenuItem(5, "Remove garage slot", new RemoveGarage(), garageSlotMenu));
        garageSlotMenu.addMenuItem(new MenuItem(6, "Back to previous menu", null, rootMenu));
    ...
    private Menu listGarageSlotsMenu() {
        ...
        listGarageSlotsMenu.addMenuItem(new MenuItem(3, "Back to previous menu", null, rootMenu));
    ...
    private Menu orderMenu() {
        ...
        orderMenu.addMenuItem(new MenuItem(8, "Back to previous menu", null, rootMenu));
